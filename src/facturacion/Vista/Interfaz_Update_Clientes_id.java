...
public  class Interfaz_Update_Clientes_id extends javax.swing.JFrame {
...
control_existencias ctrl = new control_existencias();
    ...
    public Interfaz_Update_Clientes_id(String id) {
        this.id_cliente=id;
        this.campo="id_cliente";
    ...
    public void llenar_campos(){
        ...
        cliente=ctrl.datos_clientes(this.id_cliente,this.campo);
        this.Documento=cliente[0][1].toString();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(regclientejButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(36, 36, 36)
    ...
    private void regclientejButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regclientejButton1ActionPerformed
     ...
     this.tip= id_doc.getID();
        ...
        {
        if(contr.Update_Clientes(this.campo,this.id_cliente))
        {
 ...
 /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interfaz_Update_Clientes_id("").setVisible(true);
            }
        });
    }
