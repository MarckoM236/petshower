...
public final class interfaz_gestionarticulos extends javax.swing.JInternalFrame {

    control_existencias ctrl;
    private Object[][] datostabla; 
    public interfaz_gestionarticulos() {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(jTable1.getSelectedRow()>=0){
         if(JOptionPane.showConfirmDialog(null, "Realmente desea eliminar este articulo?", "Eliminar", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)==0){
        int a1 = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
        DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
        
        boolean estado = ctrl.Delete_articulo(String.valueOf(a1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int a1 = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
       Interfaz_actualizar_articulos act = new Interfaz_actualizar_articulos(String.valueOf(a1));
        act.show();
        }
        } 
        else{
