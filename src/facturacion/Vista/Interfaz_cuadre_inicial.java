...
public class Interfaz_cuadre_inicial extends javax.swing.JInternalFrame {
    String val1="0";
    String val2="0";
    String val3="0";
    String val4="0";
    ...
    String fecha;
    String fec_reporte;
    String titulo="Cuadre Base de Caja";
    String total="0";
    
    public Interfaz_cuadre_inicial(String id, String nomb, String ape) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnreporte.setIcon(new javax.swing.ImageIcon(getClass().getResource("/facturacion/imagenes/btn_save.png"))); // NOI18N
...
//        String val11=txtval11.getText();
//        String total=txttotal.getText();
//        if(txtcant11.getText().equals("")){
//        txtval11.setText("0");
//        txtcant11.setText("0");
//        int new_total=Integer.parseInt(total) - Integer.parseInt(val11);
//        
//        txttotal.setText(Integer.toString(new_total));
//        }
        
        if(control.Registrar_cuadre_ini(id_user, fecha, txttotal.getText())){
                 JOptionPane.showMessageDialog(null,"Se registro el cuadre inicial");
    ...
    private void txtcant1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcant1KeyReleased
      ...
      this.total=control.total(val1, val2, val3, val4, val5, val6, val7, val8, val9, val10, val11, "0");
    ...
    private void btnreporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnreporteActionPerformed
        ...
        String fech="Rep_Ini_"+fec_reporte;
        try {
            control.generar_pdf_cuadre_ini(fech,titulo,nombre,txttotal.getText(),fecha,ruta,rutaIMG);
        } catch (DocumentException | IOException ex) {
            Logger.getLogger(Interfaz_cuadre_inicial.class.getName()).log(Level.SEVERE, null, ex);
        }
